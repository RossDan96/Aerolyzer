...
class Location(object):
    ...
    def coord_to_zip(self,coord,googlegeokey):
        '''
    ...
    def zip_to_coord(self,zipcode,googlegeokey):
        '''
    ...
    def sun_position(self,exifdict):
        '''
